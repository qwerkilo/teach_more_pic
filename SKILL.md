...
| 24 | 数据图表集 | `components/24-数据图表集.md` | 柱状图/饼图/折线图/堆叠图 |
...
| 分类数值对比 | 纵向柱状图 (#24a) | CSS 条形图 (#4) | 第二幕 |
| 单组数据对比 | CSS 条形图 (#4) | 纵向柱状图 (#24a) | 第二幕 |
...
| 技术/产品课 | 原生折叠 (#25a) + 幻灯片 (#25c) | 标注图片 (#14) + 柱状图 (#24a) + Popover (#25d) | 原生模态 (#25b) + 对比表 (#22) |
...
| 自然/医学课 | SVG 流程图 (#1) + 折叠分步 (#8) | 热力图 (#19) + 柱状图 (#24a) + 堆叠图 (#24d) + 标注图片 (#14) | Popover (#25d) + 幻灯片 (#25c) + 标签组 (#17) |
